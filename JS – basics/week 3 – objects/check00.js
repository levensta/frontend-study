...
/** документация гласит, что объект Date корректирует значения при любых вычислениях,
 *  но этот кейс показывает, что это не так  **/
// time = date('2017-03-30 13:45').subtract(1, 'months');
// assert.deepEqual(
//     time.value,
//     '2017-02-28 13:45',
//     'Если вычесть из 30 марта 1 месяц, должен получиться февраль с максимальным днем'
// );
